 ...
 */
class EventshandlerViewPlaces extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		EventshandlerHelper::addSubmenu('places');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_EVENTSHANDLER_TITLE_PLACES'), 'events.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_eventshandler&view=places');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_EVENTSHANDLER_PLACES_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_EVENTSHANDLER_PLACES_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_EVENTSHANDLER_PLACES_CREATED_BY'),
		'a.name' => JText::_('COM_EVENTSHANDLER_PLACES_NAME'),
		'a.address' => JText::_('COM_EVENTSHANDLER_PLACES_ADDRESS'),				
		);
	}
