...
?>
<?php if ($events){?>
	<div style="border-top:1px solid <?php echo $this->item->color3 ?>;" class="specialEvents">
		<?php foreach ($events as $event){?>
			...
			<div class="specialEvent">
	 			<h3 style="color:<?php echo $this->item->color2 ?>;" class="name"><?php echo $event->name?></h3>
